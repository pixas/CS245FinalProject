...
from models.GraphAggregate import GraphSage,GAT
import torch 
...
class General(nn.Module):
    ...
    def forward(self, author_embedding: Tensor,
        ...
        paper_list = paper_paper_map[test_papers]
        mask_list = paper_mask[test_papers]
        ...
        batch_paper_query = paper_embedding[test_papers].unsqueeze(1)
        ...
        paper_embedding_new = paper_embedding.scatter(0, torch.tensor(test_papers, 
                                                                    dtype=torch.int64, 
